...
describe('fourthlevelController', function() {
    ...
    beforeEach(function(){
        $controller("FourthLevelController as vm", {
                $scope: scope
            });
    });
   ...
   describe('before activation', function() {
	   it('should have empty fourthlevel array', function(){
	       expect(scope.vm.fourthLevels).toEqual(jasmine.anything());
	   });
	
	   it('should have empty fourthlevel array length', function(){   
	       expect(scope.vm.fourthLevels.length).toEqual(0);
	   });   
   });   
     
   describe('after activation', function() {   
	   var mockFourthlevelsResponse = [];
	   var mockFourthlevelResponse = null;
	   
	    beforeEach(function(){
	    	
	    	mockFourthlevelsResponse =  [{"id": 1,
	    	                                   ...
	    	                                   "fourthLevels": [
	    	                                     {
	    	                                       ...
	    	                                       "keywords": [
	    	                                         ...
	    	                                         {
	    	                                           "keyword": "fourth-level-common-keyword1"
	    	                                         }
	    	                                       ]
	    	                                     },
	    	                                     {
	    	                                     ...
	    	                                     },
	    	                                     {
	    	                                       ...
	    	                                       "keywords": [
	    	                                         {
	    	                                           "keyword": "fourth-level-common-keyword2"
	    	                                         },
	    	                                         {
	    	                                           "keyword": "lesson 2"
	    	                                         }
			...
			httpBackend.when('GET', 'api/fourthlevels?max=-1').respond(mockFourthlevelsResponse);  // This is also valid httpBackend.whenGET('api/fourthlevels?max=-1').respond(fourthlevelsList); or  //httpBackend.whenGET(/fourthlevels/).respond(fourthlevelsList);
			httpBackend.when('GET', 'api/fourthlevels/1?max=-1').respond(mockFourthlevelResponse);
			httpBackend.when('PUT', 'api/fourthlevels/1?max=-1').respond(mockFourthlevelResponse); 
			httpBackend.when('POST', 'api/fourthlevels?max=-1').respond(mockFourthlevelResponse); 
			httpBackend.when('DELETE', 'api/fourthlevels/1?max=-1').respond(mockFourthlevelResponse); 

	    });
	    
	   it('should respond success to a GET', function(){  
	       httpBackend.expect('GET', 'api/fourthlevels?max=-1').respond(200, 'success');
	   });  	   
		   
	    it('should have a function to refresh the fourthlevels list', function(){
	        expect(scope.vm.list).toBeDefined();
	    });
	    
	    it('should have mocked mockFourthlevelsResponse', function(){
	    	expect(mockFourthlevelsResponse.length).toBeGreaterThan(0);
	    });
	   
	   it('should not have empty fourthlevel array', function(){  
	       
	   	   scope.vm.list();
	   	   httpBackend.flush();
	       expect(scope.vm.fourthLevels.length).toBeGreaterThan(0);
	   });    

	   xit('should have fourthlevels list that matches mock', function(){  
		   
		   scope.vm.list();
		   httpBackend.flush();
		   expect(scope.vm.fourthLevels).toEqual(mockFourthlevelsResponse);
 
	   }).pend('Because the types returned are not the same.  To do with promises.  Need to understand this better.'); 
	   
	   it('should have fourthlevels list with fourthlevels that matches mock', function(){  
		   
		   scope.vm.list();
		   httpBackend.flush();
		   expect(scope.vm.fourthLevels[0].id).toEqual(1);
		   expect(scope.vm.fourthLevels[0].nonGradeLevel).toEqual("Course -");
		   expect(scope.vm.fourthLevels[0].nonGradeTitle).toEqual("United States History, Beginnings to 1877");
		   expect(scope.vm.fourthLevels[0].title).toEqual("United States History, Beginnings to 1877");
		   expect(scope.vm.fourthLevels[0].content[0].id).toEqual(9);
		   
	   }); 
	   
	   it('should add a fourthlevel to the list', function(){  
		   scope.vm.newTitle = "A new title";
		   scope.vm.newHierarchy = 9;
		   scope.vm.addFourthLevel(mockFourthlevelResponse);
		   httpBackend.flush();
		   httpBackend.expect('POST', 'api/fourthlevels?max=-1').respond(mockFourthlevelResponse); 
	   });
	   
  
	   it('should update a fourthlevel title', function(){  
		   
		   scope.vm.updateTitle(mockFourthlevelResponse, 'A new title');
		   httpBackend.flush();
		   httpBackend.expect('PUT', 'api/fourthlevels/1?max=-1').respond(mockFourthlevelResponse);
	   }); 
	
	   it('should update a fourthlevel hierarchy', function(){  
		   
		   scope.vm.updateHierarchy(mockFourthlevelResponse, '7');
		   httpBackend.flush();
		   httpBackend.expect('PUT', 'api/fourthlevels/1?max=-1').respond(mockFourthlevelResponse);
	   }); 
	   
	   it('should delete a fourthlevel from the list', function(){  
		   
		   scope.vm.delete(mockFourthlevelResponse);
		   httpBackend.flush();  
		   httpBackend.expect('DELETE', 'api/fourthlevels/1?max=-1').respond(mockFourthlevelResponse); 
