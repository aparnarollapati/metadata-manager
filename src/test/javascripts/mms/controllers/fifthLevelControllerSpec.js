...
describe('fifthlevelController', function() {
    ...
    beforeEach(function(){
        $controller("FifthLevelController as vm", {
                $scope: scope
            });
    });
   ...
   describe('before activation', function() {
	   it('should have empty fifthlevel array', function(){
	       expect(scope.vm.fifthLevels).toEqual(jasmine.anything());
	   });
	
	   it('should have empty fifthlevel array length', function(){   
	       expect(scope.vm.fifthLevels.length).toEqual(0);
	   });   
   });   
     
   describe('after activation', function() {   
	   var mockFifthlevelsResponse = [];
	   var mockFifthlevelResponse = null;
	   
	    beforeEach(function(){
	    	
	    	mockFifthlevelsResponse =  [{"id": 1,
	    	                                   ...
	    	                                   "fifthLevels": [
	    	                                     {
	    	                                       ...
	    	                                       "keywords": [
	    	                                         ...
	    	                                         {
	    	                                           "keyword": "fifth-level-common-keyword1"
	    	                                         }
	    	                                       ]
	    	                                     },
	    	                                     {
	    	                                     ...
	    	                                     },
	    	                                     {
	    	                                       ...
	    	                                       "keywords": [
	    	                                         {
	    	                                           "keyword": "fifth-level-common-keyword2"
	    	                                         },
	    	                                         {
	    	                                           "keyword": "lesson 2"
	    	                                         }
			...
			httpBackend.when('GET', 'api/fifthlevels?max=-1').respond(mockFifthlevelsResponse);  // This is also valid httpBackend.whenGET('api/fifthlevels?max=-1').respond(fifthlevelsList); or  //httpBackend.whenGET(/fifthlevels/).respond(fifthlevelsList);
			httpBackend.when('GET', 'api/fifthlevels/1?max=-1').respond(mockFifthlevelResponse);
			httpBackend.when('PUT', 'api/fifthlevels/1?max=-1').respond(mockFifthlevelResponse); 
			httpBackend.when('POST', 'api/fifthlevels?max=-1').respond(mockFifthlevelResponse); 
			httpBackend.when('DELETE', 'api/fifthlevels/1?max=-1').respond(mockFifthlevelResponse); 

	    });
	    
	   it('should respond success to a GET', function(){  
	       httpBackend.expect('GET', 'api/fifthlevels?max=-1').respond(200, 'success');
	   });  	   
		   
	    it('should have a function to refresh the fifthlevels list', function(){
	        expect(scope.vm.list).toBeDefined();
	    });
	    
	    it('should have mocked mockFifthlevelsResponse', function(){
	    	expect(mockFifthlevelsResponse.length).toBeGreaterThan(0);
	    });
	   
	   it('should not have empty fifthlevel array', function(){  
	       
	   	   scope.vm.list();
	   	   httpBackend.flush();
	       expect(scope.vm.fifthLevels.length).toBeGreaterThan(0);
	   });    

	   xit('should have fifthlevels list that matches mock', function(){  
		   
		   scope.vm.list();
		   httpBackend.flush();
		   expect(scope.vm.fifthLevels).toEqual(mockFifthlevelsResponse);
 
	   }).pend('Because the types returned are not the same.  To do with promises.  Need to understand this better.'); 
	   
	   it('should have fifthlevels list with fifthlevels that matches mock', function(){  
		   
		   scope.vm.list();
		   httpBackend.flush();
		   expect(scope.vm.fifthLevels[0].id).toEqual(1);
		   expect(scope.vm.fifthLevels[0].nonGradeLevel).toEqual("Course -");
		   expect(scope.vm.fifthLevels[0].nonGradeTitle).toEqual("United States History, Beginnings to 1877");
		   expect(scope.vm.fifthLevels[0].title).toEqual("United States History, Beginnings to 1877");
		   expect(scope.vm.fifthLevels[0].content[0].id).toEqual(9);
		   
	   }); 
	   
	   it('should add a fifthlevel to the list', function(){  
		   scope.vm.newTitle = "A new title";
		   scope.vm.newHierarchy = 9;
		   scope.vm.addFifthLevel(mockFifthlevelResponse);
		   httpBackend.flush();
		   httpBackend.expect('POST', 'api/fifthlevels?max=-1').respond(mockFifthlevelResponse); 
	   });
	   
  
	   it('should update a fifthlevel title', function(){  
		   
		   scope.vm.updateTitle(mockFifthlevelResponse, 'A new title');
		   httpBackend.flush();
		   httpBackend.expect('PUT', 'api/fifthlevels/1?max=-1').respond(mockFifthlevelResponse);
	   }); 
	
	   it('should update a fifthlevel hierarchy', function(){  
		   
		   scope.vm.updateHierarchy(mockFifthlevelResponse, '7');
		   httpBackend.flush();
		   httpBackend.expect('PUT', 'api/fifthlevels/1?max=-1').respond(mockFifthlevelResponse);
	   }); 
	   
	   it('should delete a fifthlevel from the list', function(){  
		   
		   scope.vm.delete(mockFifthlevelResponse);
		   httpBackend.flush();  
		   httpBackend.expect('DELETE', 'api/fifthlevels/1?max=-1').respond(mockFifthlevelResponse); 
