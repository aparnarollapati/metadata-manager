describe('mms.index module', function() {
    ...
    beforeEach(angular.mock.module('mms', function() {
    }));
    ...
    describe("IndexController", function() {
        ...
        beforeEach(angular.mock.inject(function($q, $controller, $rootScope) {
            ...
            scope = $rootScope.$new();
            controller = $controller('IndexController', {$scope: scope, applicationDataFactory: applicationDataFactory, contextPath: "/mms"});
        }));
        ...
        it("should assign the contextPath to a local variable on the vm", function() {
            expect(controller.contextPath).toEqual('/mms');
        });
