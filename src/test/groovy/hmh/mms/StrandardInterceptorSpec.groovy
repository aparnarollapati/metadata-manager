 ...
 */
@TestFor(StandardInterceptor)
class StrandardInterceptorSpec extends Specification {
	...
	void "Test standard NOT matching the delete action"() {
		when:"A request is made to the delete action"
		withRequest(controller:"standard", action: "delete")

		then:"The interceptor does not matches"
		!interceptor.doesMatch()
	}

	void "Test standard matching a Save action"() {
		when:"A request is made to the save action"
		withRequest(controller:"standard", action: "save")
	...
	void "Test standard NOT matching an Edit action"() {
		when:"A request is made to the edit action"
		withRequest(controller:"standard", action: "edit")
	...
	void "Test standard NOT matching an Update action"() {
		when:"A request is made to the Update action"
		withRequest(controller:"standard", action: "update")
